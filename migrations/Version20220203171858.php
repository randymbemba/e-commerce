 ...
 */
final class Version20220203171858 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier CHANGE utilisateur utilisateur VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
